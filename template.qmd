...
format:
  kr_typst_template-typst:
    ...
    font-paths:
      ...
      - _extensions/bit2r/kr_typst_template/resources/fonts
    toc: true
    toc-depth: 3
...
setup_paths <- c(
  "_extensions/kr_typst_template/resources/R/setup.R",
  "_extensions/bit2r/kr_typst_template/resources/R/setup.R"
)
source(setup_paths[file.exists(setup_paths)][1])
```
